...
from mydata import MyDataset2_class
import torchvision.transforms as transforms
from architecture import PredictiveCoder, PC_Params
import sys
sys.path.append('/media/lucas/ADATA SE760/KYR/KSY/Illusory-Contour-Predictive-Networks')
...
def classification(device,checkpoint,dataroot,batch,saveroot):
    ...
    torch.save(prob_square,PATH+saveroot)
